...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  'Vice Principal': [PERMISSIONS.DASHBOARD_VIEW_FULL, PERMISSIONS.OPERATIONS_VIEW_ALL, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL, PERMISSIONS.TIMETABLE_VIEW],
  'Subject Teacher': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.TIMETABLE_VIEW, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL],
  'Exam Coordinator': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.STUDENTS_VIEW_ALL, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL, PERMISSIONS.TIMETABLE_VIEW],
  'IT Support': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.SYSTEM_SETTINGS, PERMISSIONS.USERS_MANAGE_ALL, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL, PERMISSIONS.TIMETABLE_VIEW],
  'Librarian': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.TIMETABLE_VIEW],
  'Counselor': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.TIMETABLE_VIEW],
  'Transport Manager': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.TIMETABLE_VIEW],
  'Security Guard': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.TIMETABLE_VIEW],
  'Student': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.TIMETABLE_VIEW],
  'Parent': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.TIMETABLE_VIEW]
};
