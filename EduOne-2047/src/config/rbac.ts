...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  'Vice Principal': [PERMISSIONS.DASHBOARD_VIEW_FULL, PERMISSIONS.OPERATIONS_VIEW_ALL, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL],
  ...
  'Exam Coordinator': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.STUDENTS_VIEW_ALL, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL],
  'IT Support': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.SYSTEM_SETTINGS, PERMISSIONS.USERS_MANAGE_ALL, PERMISSIONS.AI_COMMAND_CENTER, PERMISSIONS.DOCUMENTS_UPLOAD_ALL],
  'Librarian': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER],
  'Counselor': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER],
  'Transport Manager': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER],
  'Security Guard': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER],
  'Student': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER],
  'Parent': [PERMISSIONS.DASHBOARD_VIEW_SCOPED, PERMISSIONS.AI_COMMAND_CENTER]
};
